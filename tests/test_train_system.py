...
class TestTrainSystem(unittest.TestCase):
    ...
    def test_train_system_add_station(self):
        ...
        self.assertIn(train_station, train_system.get_stations_on_line(CTATrainLine.BLUE))
    ...
    def test_train_system_add_station_with_incorrect_type(self):
        ...
        self.assertEqual(str(context.exception), '[TrainSystem]: station must be an instance of TrainStation')
    ...
    def test_train_system_get_stations_on_line(self):
        ...
        self.assertEqual(train_system.get_stations_on_line(CTATrainLine.BLUE), [train_station])
    ...
    def test_train_system_get_stations_on_line_with_invalid_line(self):
        ...
        self.assertEqual(str(context.exception), f'[TrainSystem]: {CTATrainLine.RED} line does not exist')