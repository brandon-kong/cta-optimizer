...
class TestTrainStation(unittest.TestCase):
    ...
    def test_train_station_name_must_be_a_string(self):
        ...
        self.assertEqual(str(context.exception), '[TrainStation]: name must be a string')
    ...
    def test_train_station_position_must_be_an_instance_of_position(self):
        ...
        self.assertEqual(str(context.exception), '[TrainStation]: position must be an instance of Position')
    ...
    def test_train_station_line_must_be_an_instance_of_CTATrainLine(self):
        ...
        self.assertEqual(str(context.exception), '[TrainStation]: line must be a string')
    ...
    def test_train_station_add_transfer_station_raises_error_if_station_is_not_instance_of_train_station(self):
        train_station = TrainStation(name='name', line=CTATrainLine.BLUE, position=test_position)
